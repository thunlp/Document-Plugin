...
class ConfigParser:
    ...
    def read(self, filenames, encoding=None):
        ...
        # if os.path.exists("/mnt/sfs_turbo/xcj/ReadOnce/docaspara/config/default_local.config"):
        #     self.local_config.read("/mnt/sfs_turbo/xcj/ReadOnce/docaspara/config/default_local.config", encoding=encoding)
        # else:
        #     self.local_config.read("/mnt/sfs_turbo/xcj/ReadOnce/docaspara/config/default.config", encoding=encoding)
        # self.default_config.read("/mnt/sfs_turbo/xcj/ReadOnce/docaspara/config/default.config", encoding=encoding)
